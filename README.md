...
- WinForms(C#) 기반 상태 모니터링 및 동작 제어 GUI 프로그램 개발  
### 3. 수행목표  
...
### 6. 상세 내용  
1. 목적  
 RTOS 운영체제를 적용하여 긴급 중지 버튼이 장비의 작동을 중지시키는 것을 보장하고  
 화재와 같은 긴급 상황 발생 시 센서를 통해 감지하고 즉각적으로 경고를 발생시킨다.   
 평상시는 설비 상태를 안정적으로 모니터링할 수 있는 태스크 우선순위 기반 안전 관리 시스템을 구축하는 것을 목표한다.  
2. 개발환경  
...
### 11. SmartFactory_SW 구현 교육 전체 개요  
1. C# 기본 문법 공부  
2. WinFormsApp 구현  
